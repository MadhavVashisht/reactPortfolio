...
const socials = [
  {
    Icon: FaGithub,
    label: "Github",
    href: "https://github.com/MadhavVashisht",
  },
  {
    Icon: FaLinkedin,
    label: "LinkedIn",
...
const glowVariant = {
  ...
  hover: {
    ...
    y: -3,
    filter:
      "drop-shadow(0 0 8px rgba(13, 88, 204, 0.9)) drop-shadow(0 0 18px rgba(16, 185, 123, 0.8))",
    transition: {
      duration: 0.3,
      repeat: Infinity,
      repeatType: "reverse",
...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_50%_at_30%_70%,rgba(16,185,129,0.30),transparent_70%)]"/>
      ...
      >
        ...
        <div className="h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from-[#0d58cc] via-cyan-300 to bg-emerald-400" />
        ...
        <p className="text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Madhav Vashisht. All rights reserved
        </p>
      </motion.div>
    </footer>
  );
